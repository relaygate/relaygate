...
func Render(r *resources.Resources) (map[string]any, string, error) {
	...
	return cfg, renderNFT(rules, defaults.Nft), nil
}
...
func renderNFT(rules []resources.Rule, nft resources.NftDefaults) string {
...
# Source: DataDir/resources.yaml (defaults.nft + enabled rules)
